...
Subida de temperatura desde cilindro recién sacado del frigo. Los datos de temperatura se han obtenido a partir de la tabla de equivalencias del resistor aplicando interpolación lineal.
...
- AL PRINCIPIO MEDIDAS SIN SENTIDO
- CONSIDERAR LA CORRECIÓN DE LA PERDIDA DE CALOR EN LA SEGUNDA EXPERENCIA LINEAL
- INTERPOLACION PARA LAS T ASOCIADAS A LAS R EN LA TABLA
