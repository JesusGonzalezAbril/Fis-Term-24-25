...
```{r, echo=FALSE,  out.width= "70%", fig.align='center', fig.cap="Ajuste por mínimos cuadrados para la experiencia 2"}
# Datos recogidos
T0 <- 27 # Celsius
