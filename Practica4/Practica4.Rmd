...
Dados los resultados obtenidos y teniendo en cuenta especialmente el valor sin sentido obtenido para la constante $R$, resulta obvio que debe existir un error de método en el experimento realizado. 
